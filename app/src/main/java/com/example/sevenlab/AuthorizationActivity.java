...
public class AuthorizationActivity extends Activity
{
    ...
    private void SignIn()
    {
        ...
        new ThreadTask(handler, databaseHandler).SignIn(login, password);
    }
    ...
    private void SignUp()
    {
        ...
        new ThreadTask(handler, databaseHandler).SignUp(user);
    }
    ...
    private void DeleteUser()
    {
        ...
        new ThreadTask(handler, databaseHandler).DeleteUser(user.GetLogin(), user.GetPassword());
    }
    ...
    private void ChangePassword()
    {
        ...
        new ThreadTask(handler, databaseHandler).UpdatePassword(user.GetLogin(), user.GetPassword());
    }
}
